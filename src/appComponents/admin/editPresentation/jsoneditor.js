...
(function() {
  ...
  var JSONEditor = function(element,options,imagePath) {
  ...
  JSONEditor.AbstractEditor = Class.extend({
    ...
    getLink: function(data) {
      ...
      // Image links
      // this is the image used in the presenation
      if(type === 'image') {
        ...
        this.link_watchers.push(function(vars) {
          ...
          if(this.jsoneditor.imagePath && url!=''){
            url = this.jsoneditor.imagePath + '/' + url
          }
  ...
  console.log('creating image 2222', this.jsoneditor)
          if(this.jsoneditor.imagePath){
            img.src = this.jsoneditor.imagePath + "/" + this.value;
          }else{
            img.src = this.value;
          }
  ...
  JSONEditor.defaults.editors.upload = JSONEditor.AbstractEditor.extend({
    ...
    refreshPreview: function() {
      ...
      // This is the preview image right after uploaded (so, temporary)
